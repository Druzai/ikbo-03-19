...
import ru.mirea.practika16.*;

import javax.swing.*;
import java.awt.*;

public class OrdersUI extends JFrame {
    JButton internet_bt, restaurant_bt, list_orders, exit, choose_drink, choose_dish, enter_data, back, ready_order;
    JPanel pnl1, pnl3;
    choice_order pnl2;
    JTextField jta;
    ...
    public JPanel create_pnl1(){
        ...
        tx1.setBounds(160, 20,300,80);
        internet_bt.setBounds(200, 120,200,80);
        restaurant_bt.setBounds(200,220,200,80);
        list_orders.setBounds(200, 320,200,80);
        exit.setBounds(200, 420,200,80);
